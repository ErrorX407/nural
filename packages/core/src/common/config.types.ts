...
import { ErrorHandler, ErrorHandlerConfig } from "../exceptions/error-handler.provider";
import { CorsConfig, HelmetConfig } from "../pipeline/middleware/middleware-config";
import { LoggerConfig } from "./logger.provider";
...
export interface ScalarConfig {
  ...
  spec?: { url?: string; content?: string | Record<string, unknown> };
  proxyUrl?: string;
  isEditable?: boolean;
  showSidebar?: boolean;
  hideModels?: boolean;
  ...
  hiddenClients?: string[] | boolean | Record<string, unknown>;
