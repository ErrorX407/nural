...
import type { ZodAny, RouteConfig } from "./route-storage.types";
...
>(
  ...
  >(
    ...
    const combinedMiddleware = [...baseMiddleware, ...localMiddleware].filter((mw): mw is typeof mw => typeof mw === 'function');
